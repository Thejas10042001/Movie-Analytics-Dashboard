...
export const FilterBar: React.FC<FilterBarProps> = ({ filters, setFilters }) => {
  ...
  const handleSourceChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    setFilters(prev => ({
      ...prev,
      ratingSource: e.target.value as 'imdb' | 'rottenTomatoes',
    }));
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            {(Object.values(LanguageType) as LanguageType[]).map(lang => (
              <label
                key={lang}
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            {(Object.values(GenreType) as GenreType[])
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="space-y-3">
            ...
            <div className="relative w-full h-6 flex items-center select-none touch-none mt-4">
              {/* Background Track */}
              <div className="absolute w-full h-1 bg-gray-700 rounded z-0" />
